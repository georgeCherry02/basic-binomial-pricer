...
fn get_black_scholes_test_risk_factors<T: BlackScholes>(option: &T) -> RiskFactors {
...
pub fn get_test_inputs_call() -> (Call, DateTime<Utc>, RiskFactors) {
    ...
    let risk_factors = get_black_scholes_test_risk_factors(&call);
...
pub fn get_test_inputs_put() -> (Put, DateTime<Utc>, RiskFactors) {
    ...
    let risk_factors = get_black_scholes_test_risk_factors(&put);
